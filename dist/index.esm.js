...
function ImageUploader(_a) {
    ...
    return (React__default.createElement("div", { className: "border-2 border-dashed border-gray-300 hover:border-blue-400 hover:bg-blue-50/30 transition-all duration-300 rounded-xl relative group h-[200px] cursor-pointer overflow-hidden flex items-center justify-center" },
        ...
        React__default.createElement("button", { type: "button", onClick: function () { var _a; return (_a = inputRef.current) === null || _a === void 0 ? void 0 : _a.click(); }, className: "flex flex-col items-center text-gray-600", disabled: isUploading }, isUploading ? (React__default.createElement(React__default.Fragment, null,
            React__default.createElement("img", { src: "/rte-editor/upload_prescription.svg", alt: "uploading", width: 90, height: 90, className: "animate-bounce" }),
...
function TableControls(_a) {
    ...
    return (React__default.createElement("div", null,
        React__default.createElement("button", { className: "fixed z-40 bg-blue-500 hover:bg-blue-600 text-white w-7 h-7 rounded-full font-bold flex items-center justify-center shadow-lg transition-colors", style: { top: buttonPos.top, left: buttonPos.left }, onClick: function () { return setOpen(function (o) { return !o; }); }, "aria-label": "Table options", title: "Table options" },

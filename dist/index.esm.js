...
var YoutubeIcon = function (props) { return (React__default.createElement("svg", __assign({ width: "25", height: "25", fill: "none", xmlns: "http://www.w3.org/2000/svg" }, props),
    React__default.createElement("path", { d: "M14.783 6.252c-.726-.01-1.544-.01-2.468-.01-4 0-6 0-7.244.87-1.242.87-1.242 2.27-1.242 5.07 0 2.8-.001 4.2 1.242 5.07 1.243.87 3.243.87 7.244.87 4 0 6.001 0 7.243-.87 1.243-.87 1.243-2.27 1.243-5.07 0-.458 0-.878-.006-1.265", stroke: "#000", strokeWidth: 1.33, strokeLinecap: "round", strokeLinejoin: "round" }),
    React__default.createElement("path", { d: "M10.467 9.806v4.752a.465.465 0 0 0 .468.463.455.455 0 0 0 .26-.077L14.8 12.59a.462.462 0 0 0 .004-.77l-3.606-2.397a.471.471 0 0 0-.651.125.454.454 0 0 0-.08.259Z", stroke: "#000", strokeWidth: 1.33, strokeLinecap: "round", strokeLinejoin: "round" }),
    React__default.createElement("path", { d: "M16.801 7.218h4m-2-2v4", stroke: "#000", strokeWidth: 1.333, strokeLinecap: "round", strokeLinejoin: "round" }))); };

var AddRowIcon = React.memo(function (_a) {
    var className = _a.className, props = __rest(_a, ["className"]);
    return (React.createElement("svg", __assign({ width: "20", height: "20", fill: "none", xmlns: "http://www.w3.org/2000/svg", className: className }, props),
        React.createElement("path", { d: "M12.825 4.185h-6a3 3 0 0 0-3 3v6a3 3 0 0 0 3 3h6a3 3 0 0 0 3-3v-1.423", stroke: "#000", strokeLinecap: "round" }),
        React.createElement("path", { d: "M4.192 7.81h13.032", stroke: "#000" }),
        React.createElement("path", { d: "m14.918 5.504 2.306 2.306-2.306 2.305", stroke: "#000", strokeLinecap: "round", strokeLinejoin: "round" }),
        React.createElement("path", { fill: "#fff", d: "M6.136 10.715h7.572v7.572H6.136z" }),
        React.createElement("path", { d: "M9.913 11.91v5.182m2.597-2.597H7.328", stroke: "#000", strokeWidth: "1.099", strokeLinecap: "round", strokeLinejoin: "round" })));
});
AddRowIcon.displayName = "AddRowIcon";

var AddColumnIcon = React.memo(function (_a) {
    var className = _a.className, props = __rest(_a, ["className"]);
    return (React.createElement("svg", __assign({ width: "20", height: "20", fill: "none", xmlns: "http://www.w3.org/2000/svg", className: className }, props),
        React.createElement("path", { d: "M3.889 12.77v-6a3 3 0 0 1 3-3h6a3 3 0 0 1 3 3v6a3 3 0 0 1-3 3h-1.423", stroke: "#000", strokeLinecap: "round" }),
        React.createElement("path", { d: "M7.514 4.137V17.17", stroke: "#000" }),
        React.createElement("path", { d: "m5.208 14.863 2.306 2.306 2.305-2.306", stroke: "#000", strokeLinecap: "round", strokeLinejoin: "round" }),
        React.createElement("path", { fill: "#fff", d: "M10.418 5.984h7.572v7.572h-7.572z" }),
        React.createElement("path", { d: "M14.195 7.18v5.18m2.597-2.596H11.61", stroke: "#000", strokeWidth: "1.099", strokeLinecap: "round", strokeLinejoin: "round" })));
});
AddColumnIcon.displayName = "AddColumnIcon";

var DeleteColumnIcon = React.memo(function (_a) {
    var className = _a.className, props = __rest(_a, ["className"]);
    return (React.createElement("svg", __assign({ width: "20", height: "20", fill: "none", xmlns: "http://www.w3.org/2000/svg", className: className }, props),
        React.createElement("path", { d: "M3.889 12.77v-6a3 3 0 0 1 3-3h6a3 3 0 0 1 3 3v6a3 3 0 0 1-3 3h-1.423", stroke: "#DC362E", strokeLinecap: "round" }),
        React.createElement("path", { d: "M7.514 4.137V17.17", stroke: "#DC362E" }),
        React.createElement("path", { d: "m5.208 14.863 2.306 2.306 2.305-2.306", stroke: "#DC362E", strokeLinecap: "round", strokeLinejoin: "round" }),
        React.createElement("path", { fill: "#fff", d: "M10.418 5.984h7.572v7.572h-7.572z" }),
        React.createElement("path", { d: "m16.03 7.934-3.665 3.664m3.672 0-3.664-3.664", stroke: "#DC362E", strokeWidth: "1.099", strokeLinecap: "round", strokeLinejoin: "round" })));
});
DeleteColumnIcon.displayName = "DeleteColumnIcon";

var DeleteRowIcon = React.memo(function (_a) {
    var className = _a.className, props = __rest(_a, ["className"]);
    return (React.createElement("svg", __assign({ width: "20", height: "20", fill: "none", xmlns: "http://www.w3.org/2000/svg", className: className }, props),
        React.createElement("path", { d: "M12.93 4.002h-6a3 3 0 0 0-3 3v6a3 3 0 0 0 3 3h6a3 3 0 0 0 3-3v-1.423", stroke: "#DC362E", strokeLinecap: "round" }),
        React.createElement("path", { d: "M4.297 7.627h13.031", stroke: "#DC362E" }),
        React.createElement("path", { d: "m15.023 5.321 2.305 2.306-2.305 2.305", stroke: "#DC362E", strokeLinecap: "round", strokeLinejoin: "round" }),
        React.createElement("path", { fill: "#fff", d: "M6.24 10.532h7.572v7.572H6.24z" }),
        React.createElement("path", { d: "m11.852 12.482-3.664 3.664m3.672 0-3.665-3.664", stroke: "#DC362E", strokeWidth: 1.099, strokeLinecap: "round", strokeLinejoin: "round" })));
});
DeleteRowIcon.displayName = "DeleteRowIcon";

var UploadIcon = React.memo(function (_a) {
    var className = _a.className, props = __rest(_a, ["className"]);
    return (React.createElement("svg", __assign({ width: "162", height: "162", fill: "none", xmlns: "http://www.w3.org/2000/svg", className: className }, props),
        React.createElement("rect", { x: ".625", y: ".743", width: "161.097", height: "161.097", rx: "80.548", fill: "#EDEAF3" }),
        React.createElement("g", { clipPath: "url(#a)" },
            React.createElement("path", { d: "M52.235 49.716h50.345a2.638 2.638 0 0 1 2.637 2.638v67.16a2.639 2.639 0 0 1-2.637 2.637H52.235a2.639 2.639 0 0 1-2.637-2.637v-67.16a2.639 2.639 0 0 1 2.637-2.638Z", fill: "#8373AD" }),
            React.createElement("path", { fillRule: "evenodd", clipRule: "evenodd", d: "M49.605 119.514v-53.45c0-1.135.405-2.112 1.207-2.914L63.04 50.923a3.98 3.98 0 0 1 2.914-1.207h36.635c.918 0 1.667.75 1.667 1.668v67.796a2.005 2.005 0 0 1-2.001 2.001h-50.98a1.67 1.67 0 0 1-1.669-1.667Z", fill: "#AA9FC6" }),
            React.createElement("path", { fillRule: "evenodd", clipRule: "evenodd", d: "M40.316 110.228v-53.45a3.98 3.98 0 0 1 1.207-2.914L53.75 41.637a3.98 3.98 0 0 1 2.914-1.207h36.635a2.643 2.643 0 0 1 2.637 2.638v67.16a2.642 2.642 0 0 1-2.638 2.637H42.955a2.643 2.643 0 0 1-2.638-2.637Z", fill: "#8373AD" }),
            React.createElement("path", { fillRule: "evenodd", clipRule: "evenodd", d: "M40.316 110.228v-53.45a3.98 3.98 0 0 1 1.207-2.914L53.75 41.637a3.98 3.98 0 0 1 2.914-1.207h36.635c.918 0 1.667.75 1.667 1.668v67.796a2.005 2.005 0 0 1-2.001 2.001h-50.98a1.67 1.67 0 0 1-1.669-1.667Z", fill: "#C6BED9" }),
            React.createElement("path", { fillRule: "evenodd", clipRule: "evenodd", d: "M53.75 41.637a3.98 3.98 0 0 1 2.914-1.207h1.046a4.137 4.137 0 0 0-2.562 3.814v8.381a2.642 2.642 0 0 1-2.637 2.637h-8.38a4.138 4.138 0 0 0-3.815 2.562v-1.046a3.98 3.98 0 0 1 1.207-2.914L53.75 41.637Z", fill: "#8373AD" }),
            React.createElement("path", { fillRule: "evenodd", clipRule: "evenodd", d: "M53.75 41.637a3.98 3.98 0 0 1 2.914-1.207h1.046c-1.275.237-3.462 1.457-3.462 3.814v8.381c0 .956-.781 1.737-1.737 1.737h-8.38c-1.136 0-3.12.465-3.815 3.462v-1.046a3.98 3.98 0 0 1 1.207-2.914L53.75 41.637Z", fill: "#AA9FC6" }),
            React.createElement("path", { fillRule: "evenodd", clipRule: "evenodd", d: "M48.733 62.947a1.334 1.334 0 1 1 0-2.669h22.216a1.334 1.334 0 0 1 0 2.669H48.733Zm13.634-7.418a1.334 1.334 0 0 1 0-2.668h11.6a1.334 1.334 0 0 1 0 2.668h-11.6Zm15.557 0a1.334 1.334 0 0 1 0-2.668h1.719a1.334 1.334 0 0 1 0 2.668h-1.72Zm5.676 0a1.334 1.334 0 0 1 0-2.668h3.922a1.334 1.334 0 0 1 0 2.668H83.6Zm-34.867 44.905a1.334 1.334 0 1 1 0-2.668h4.3a1.334 1.334 0 0 1 0 2.668h-4.3Zm8.258 0a1.334 1.334 0 1 1 0-2.668h10.361a1.334 1.334 0 1 1 0 2.668h-10.36Zm-8.258-7.497a1.334 1.334 0 1 1 0-2.669h10.89a1.334 1.334 0 0 1 0 2.669h-10.89Zm14.847 0a1.334 1.334 0 0 1 0-2.669h5.117a1.334 1.334 0 0 1 0 2.669H63.58Zm-14.847-7.498a1.334 1.334 0 1 1 0-2.668h8.472a1.334 1.334 0 0 1 0 2.668h-8.472Zm12.43 0a1.334 1.334 0 1 1 0-2.668h1.719a1.334 1.334 0 0 1 0 2.668h-1.72Zm5.676 0a1.334 1.334 0 1 1 0-2.668h4.985a1.334 1.334 0 0 1 0 2.668h-4.985Zm-18.106-7.497a1.334 1.334 0 0 1 0-2.669h4.3a1.334 1.334 0 0 1 0 2.669h-4.3Zm8.258 0a1.334 1.334 0 0 1 0-2.669h19.774a1.334 1.334 0 0 1 0 2.669H56.99Zm-8.258-7.498a1.334 1.334 0 0 1 0-2.668h30.903a1.334 1.334 0 0 1 0 2.668H48.733Zm34.86 0a1.334 1.334 0 1 1 0-2.668h3.929a1.334 1.334 0 0 1 0 2.668h-3.928Zm-8.686-7.498a1.334 1.334 0 1 1 0-2.668h.075a1.334 1.334 0 1 1 0 2.669h-.075Zm4.032 0a1.334 1.334 0 0 1 0-2.668h8.583a1.334 1.334 0 0 1 0 2.669h-8.583Z", fill: "#8373AD" }),
            React.createElement("path", { d: "M115.281 115.412c8.982-8.981 8.982-23.542 0-32.523-8.981-8.981-23.542-8.981-32.523 0-8.981 8.98-8.981 23.542 0 32.523 8.981 8.981 23.542 8.981 32.523 0Z", fill: "#32215E" }),
            React.createElement("path", { fillRule: "evenodd", clipRule: "evenodd", d: "M87.145 118.845c-6.661-4.03-11.114-11.342-11.114-19.695 0-8.352 4.453-15.665 11.114-19.694a22.458 22.458 0 0 1 11.012-2.867c12.46 0 22.561 10.101 22.561 22.561 0 12.461-10.101 22.562-22.561 22.562-4 0-7.755-1.042-11.012-2.867Z", fill: "#462E84" }),
            React.createElement("path", { fillRule: "evenodd", clipRule: "evenodd", d: "M89.7 102.502v3.614c0 1.104.897 2.002 2 2.002h14.665a2.004 2.004 0 0 0 2.002-2.002v-3.614a1.335 1.335 0 0 1 2.668 0v3.614a4.675 4.675 0 0 1-4.67 4.67H91.701a4.675 4.675 0 0 1-4.67-4.67v-3.614a1.335 1.335 0 0 1 2.668 0Zm9.333 2.151c.737 0 1.333-.597 1.333-1.334V92.07l1.415 1.414a1.333 1.333 0 1 0 1.888-1.888l-3.693-3.69a1.331 1.331 0 0 0-1.886 0l-3.693 3.69a1.336 1.336 0 0 0 1.888 1.888l1.413-1.414v11.249c0 .737.599 1.334 1.335 1.334Z", fill: "#EDEAF3" })),
        React.createElement("defs", null,
            React.createElement("clipPath", { id: "a" },
                React.createElement("path", { fill: "#fff", transform: "translate(38.477 38.596)", d: "M0 0h85.39v85.39H0z" })))));
});
UploadIcon.displayName = "UploadIcon";

var LogoIcon = function (props) { return (React__default.createElement("svg", __assign({ width: "36", height: "36", fill: "none", xmlns: "http://www.w3.org/2000/svg" }, props),
    React__default.createElement("circle", { cx: "18.224", cy: "17.683", r: "6.457", fill: "#462E84" }),
    React__default.createElement("path", { d: "M14.003 14.326c.634-.802 1.534-1.657 3.298-1.84.953-.098 1.954 1.278-.165 1.84-2.119.562-2.963 2.362-3.133 3.447-.155.982-.821 1.233-1.053 0-.086-.454.043-2.17 1.053-3.447Z", fill: "#AB92EC" }),
    React__default.createElement("path", { d: "M22.2 21.879c-.682.7-1.618 1.189-2.179 1.33-1.22.304-1.592-.457-.924-1.145.742-.764 2.186-1.17 2.706-1.17s1.166.197.398.985Z", fill: "#2F166F" }),
    React__default.createElement("path", { d: "M30.673 17.683c0-6.876-5.573-12.449-12.448-12.449-6.876 0-12.449 5.573-12.449 12.449 0 6.875 5.574 12.448 12.449 12.448s12.448-5.573 12.448-12.448Zm1.052 0c0 7.455-6.045 13.5-13.5 13.5-7.456 0-13.5-6.045-13.5-13.5 0-7.456 6.044-13.5 13.5-13.5 7.455 0 13.5 6.044 13.5 13.5Z", fill: "#271949" }),
    React__default.createElement("circle", { cx: "18.224", cy: "4.682", r: "3.435", fill: "#1CA3A2" }),
    React__default.createElement("path", { d: "M17.745 4.084c-.698.827-.939 3.04-1.692 2.445-1.132-.893-.682-2.808 0-3.66.466-.584 1.943-1.666 3.396-.78.694.422-.99 1.15-1.704 1.995Z", fill: "#7BE4E3" }))); };
...
function ImageUploader(_a) {
    ...
    return (React__default.createElement("div", { className: "border-2 border-dashed border-gray-300 hover:border-blue-400 hover:bg-blue-50/30 transition-all duration-300 rounded-xl relative group h-[200px] cursor-pointer overflow-hidden flex items-center justify-center" },
        React__default.createElement("input", { ref: inputRef, type: "file", accept: accept, className: "hidden", onChange: function (e) { return handleFiles(e.target.files); } }),
        React__default.createElement("button", { type: "button", onClick: function () { var _a; return (_a = inputRef.current) === null || _a === void 0 ? void 0 : _a.click(); }, className: "flex flex-col items-center text-gray-600", disabled: isUploading }, isUploading ? (React__default.createElement(React__default.Fragment, null,
            React__default.createElement(UploadIcon, { className: "w-8 h-8 animate-bounce" }),
            React__default.createElement("span", { className: "mt-2" }, "Uploading..."))) : (React__default.createElement(React__default.Fragment, null,
            React__default.createElement("svg", { xmlns: "http://www.w3.org/2000/svg", className: "h-8 w-8", viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", strokeWidth: "2", strokeLinecap: "round", strokeLinejoin: "round" },
                React__default.createElement("path", { d: "M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4" }),
                React__default.createElement("polyline", { points: "17 8 12 3 7 8" }),
                React__default.createElement("line", { x1: "12", y1: "3", x2: "12", y2: "15" })),
            React__default.createElement("span", { className: "mt-2" }, "Click to upload")))),
        error && (React__default.createElement("div", { className: "absolute bottom-2 left-2 right-2 text-xs text-red-600 bg-white/80 px-2 py-1 rounded-md border border-red-200" }, error))));
}
...
function ImageModal(_a) {
    ...
    return (React__default.createElement("div", { className: "fixed inset-0 bg-black/30 flex items-center justify-center z-50" },
        React__default.createElement("div", { className: "bg-white p-4 rounded-lg shadow-xl w-full max-w-md z-[9999] border border-gray-200" },
            ...
            React__default.createElement("div", { className: "space-y-4" },
                React__default.createElement(ImageUploader, { token: token, onUploaded: function (uploaded) {
...
var AIModal = function (_a) {
    ...
    return (React__default.createElement("div", { style: overlayStyle },
        React__default.createElement("div", { style: modalStyle },
            React__default.createElement("button", { onClick: closeModal, style: closeBtnStyle },
                React__default.createElement(CloseIcon, { className: "w-5 h-5" })),
            React__default.createElement("div", { style: { marginBottom: '24px', display: 'flex', alignItems: 'center', gap: '8px' } },
                React__default.createElement("div", { style: { padding: '8px', backgroundColor: '#f3e8ff', borderRadius: '50%' } },
                    React__default.createElement(MagicPencilIcon, { className: "w-6 h-6" })),
                React__default.createElement("h2", { style: { fontSize: '20px', fontWeight: 700, color: '#1f2937', margin: 0 } }, "Generate Content with AI")),
            React__default.createElement("form", { onSubmit: handleSubmit },
                React__default.createElement("div", { style: { marginBottom: '16px' } },
                    React__default.createElement("label", { style: labelStyle }, "Prompt"),
                    React__default.createElement("textarea", { value: prompt, onChange: function (e) { return setPrompt(e.target.value); }, placeholder: "Describe what you want to write about...", style: textareaStyle, required: true })),
                React__default.createElement("div", { style: { display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '16px', marginBottom: '24px' } },
                    React__default.createElement("div", null,
                        React__default.createElement("label", { style: labelStyle }, "Length"),
                        React__default.createElement("select", { value: length, onChange: function (e) { return setLength(e.target.value); }, style: selectStyle },
                    ...
                    React__default.createElement("div", null,
                        React__default.createElement("label", { style: labelStyle }, "Style"),
                        React__default.createElement("select", { value: style, onChange: function (e) { return setStyle(e.target.value); }, style: selectStyle },
                ...
                React__default.createElement("div", { style: { display: 'flex', justifyContent: 'flex-end', gap: '12px' } },
                    React__default.createElement("button", { type: "button", onClick: closeModal, style: cancelBtnStyle, disabled: isLoading }, "Cancel"),
                    React__default.createElement("button", { type: "submit", disabled: isLoading, style: submitBtnStyle }, isLoading ? (React__default.createElement(React__default.Fragment, null,
                        React__default.createElement("svg", { style: { height: '16px', width: '16px', animation: 'spin 1s linear infinite', color: '#ffffff' }, xmlns: "http://www.w3.org/2000/svg", fill: "none", viewBox: "0 0 24 24" },
                            React__default.createElement("circle", { style: { opacity: 0.25 }, cx: "12", cy: "12", r: "10", stroke: "currentColor", strokeWidth: "4" }),
                            React__default.createElement("path", { style: { opacity: 0.75 }, fill: "currentColor", d: "M4 12a8 8 0 018-8V0C5.373 0 0 5.373 0 12h4zm2 5.291A7.962 7.962 0 014 12H0c0 3.042 1.135 5.824 3 7.938l3-2.647z" })),
...
var MenuBar = function (_a) {
    ...
    return (React__default.createElement("div", { className: "border-b border-gray-200 bg-white z-[9999] rounded-lg" },
        React__default.createElement("div", { className: "flex flex-wrap items-center gap-1 sm:gap-2.5 px-2 sm:px-4 py-2 overflow-x-auto overflow-y-visible" },
            ...
            React__default.createElement("div", { className: "flex items-center gap-1" },
                ...
                React__default.createElement("button", { onClick: function () { return setIsTableModalOpen(true); }, className: "p-1.5 rounded-md transition-colors hover:bg-gray-100 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-blue-500", title: "Insert Table" },
                ...
                isTableSelected && (React__default.createElement(React__default.Fragment, null,
                    ...
                    React__default.createElement("button", { onClick: function () { return editor.chain().focus().addRowAfter().run(); }, className: "mt-2 rounded-md transition-colors hover:bg-green-50 bg-green-50/50 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-green-500", title: "Add Row Below" },
                        React__default.createElement(AddRowIcon, { className: "w-8 h-8 text-gray-800" })),
                    React__default.createElement("button", { onClick: function () { return editor.chain().focus().addColumnAfter().run(); }, className: "mt-2 rounded-md transition-colors hover:bg-green-50 bg-green-50/50 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-green-500", title: "Add Column Right" },
                        React__default.createElement(AddColumnIcon, { className: "w-8 h-8 text-gray-800" })),
                    React__default.createElement("button", { onClick: function () { return editor.chain().focus().deleteRow().run(); }, className: "mt-2 rounded-md transition-colors hover:bg-red-50 bg-red-50/50 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-red-500", title: "Delete Row" },
                        React__default.createElement(DeleteRowIcon, { className: "w-8 h-8 text-gray-800" })),
                    React__default.createElement("button", { onClick: function () { return editor.chain().focus().deleteColumn().run(); }, className: "mt-2 rounded-md transition-colors hover:bg-red-50 bg-red-50/50 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-red-500", title: "Delete Column" },
                        React__default.createElement(DeleteColumnIcon, { className: "w-8 h-8 text-gray-800" })),
        ...
        React__default.createElement(AIModal, { isOpen: isAIModalOpen, closeModal: function () { return setIsAIModalOpen(false); }, editor: editor, aiBaseUrl: aiBaseUrl, token: token, onAIChange: onAIChange })));
};
...
var AIBubbleMenu = function (_a) {
    ...
    var _d = useState([]), languages = _d[0], setLanguages = _d[1];
    var _e = useState(false), langLoading = _e[0], setLangLoading = _e[1];
    var bubbleMenuRef = useRef(null);
    var langPickerRef = useRef(null);
    var translateBtnRef = useRef(null);
    var _f = useState({ top: 0, left: 0 }), dropdownPos = _f[0], setDropdownPos = _f[1];
    useEffect(function () {
    ...
    return (React__default.createElement(React__default.Fragment, null,
        React__default.createElement(BubbleMenu, { ref: bubbleMenuRef, editor: editor, options: {
                placement: 'top',
                strategy: 'fixed',
                offset: 10,
                flip: {
            ...
            React__default.createElement("div", { style: menuContainerStyle },
                ...
                React__default.createElement("div", { style: dividerStyle }),
                ...
                React__default.createElement("div", { style: dividerStyle }),
                React__default.createElement("div", { style: { position: 'relative' }, ref: translateBtnRef },
        ...
        showLangPicker && createPortal(React__default.createElement("div", { ref: langPickerRef, style: dropdownStyle }, langLoading ? (React__default.createElement("div", { style: { padding: '12px', textAlign: 'center', fontSize: '12px', color: '#6b7280' } }, "Loading languages...")) : languages.length === 0 ? (React__default.createElement("div", { style: { padding: '12px', textAlign: 'center', fontSize: '12px', color: '#6b7280' } }, adminUserApiUrl ? 'No languages available' : 'Set adminUserApiUrl prop to load languages')) : (languages.map(function (lang) { return (React__default.createElement("button", { key: lang.code, onClick: function () { return handleAction('translate', lang.code); }, style: langBtnStyle, onMouseEnter: function (e) {
...
var MenuButton = function (_a) {
    ...
    return (React__default.createElement("button", { onClick: onClick, style: baseStyle, disabled: isActive, onMouseEnter: function () { return setHovered(true); }, onMouseLeave: function () { return setHovered(false); } },
        icon,
        label,
        isActive && (React__default.createElement("svg", { style: { animation: 'spin 1s linear infinite', height: '12px', width: '12px', color: '#7c3aed', marginLeft: '4px' }, xmlns: "http://www.w3.org/2000/svg", fill: "none", viewBox: "0 0 24 24" },
            React__default.createElement("circle", { style: { opacity: 0.25 }, cx: "12", cy: "12", r: "10", stroke: "currentColor", strokeWidth: "4" }),
            React__default.createElement("path", { style: { opacity: 0.75 }, fill: "currentColor", d: "M4 12a8 8 0 018-8V0C5.373 0 0 5.373 0 12h4zm2 5.291A7.962 7.962 0 014 12H0c0 3.042 1.135 5.824 3 7.938l3-2.647z" })))));
};
...
var RichTextEditor = function (_a) {
    ...
    return (React__default.createElement("div", { className: "w-full bg-white rounded-lg shadow-lg" },
        React__default.createElement("div", { className: "sticky top-0 z-50 border-b border-gray-200 bg-white shadow-sm rounded-t-lg" },
            React__default.createElement("div", { className: "flex items-center justify-start p-2" },
        ...
        editor && (React__default.createElement(EditorContainer, null,
            React__default.createElement("div", { className: "min-h-[300px] border-t border-gray-200" },
                React__default.createElement(AIBubbleMenu, { editor: editor, aiBaseUrl: aiBaseUrl, adminUserApiUrl: adminUserApiUrl, token: token, onAIChange: onAIChange }),
...
export { FindReplace, ImageModal, LinkModal, MenuBar, RichTextEditor, TableModal, YouTubeNodeView, YoutubeAlign, YoutubeModal, expandText, fetchLanguages, generateContent, processSelectedText, rephraseText, summarizeText, translateHtml, translateText };

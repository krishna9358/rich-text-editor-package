    ...
    return (React.createElement("div", { className: "fixed inset-0 bg-black/30 flex items-center justify-center z-50" },
        React.createElement("div", { className: "bg-white p-4 rounded-lg shadow-xl w-full max-w-md z-[9999] border border-gray-200" },
            React.createElement("div", { className: "flex justify-between items-center mb-4" },
                React.createElement("h3", { className: "text-lg font-semibold" }, "Attach Video"),
                React.createElement("button", { onClick: closeModal, className: "text-gray-500 hover:text-gray-700" }, "Close")),
            React.createElement("div", { className: "space-y-4" },
                React.createElement("div", null,
                    React.createElement("label", { className: "block text-sm font-medium text-gray-700 mb-1" }, "Video URL"),
                    ...
                    React.createElement("p", { className: "text-xs text-gray-500 mt-1" }, "Accepts YouTube URLs (youtube.com, youtu.be) or video IDs")),
                React.createElement("div", { className: "grid grid-cols-2 gap-4" },
                    React.createElement("div", null,
                        React.createElement("label", { className: "block text-sm font-medium text-gray-700 mb-1" }, "Width (px)"),
                        React.createElement("input", { value: width, onChange: handleWidthChange, placeholder: "e.g., 640", type: "number", min: "320", step: "10", className: "w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500" }),
                        React.createElement("p", { className: "mt-1 text-xs text-gray-500" }, "Min: 320px")),
                    React.createElement("div", null,
                        React.createElement("label", { className: "block text-sm font-medium text-gray-700 mb-1" }, "Height (px)"),
                        React.createElement("input", { value: height, onChange: handleHeightChange, placeholder: "e.g., 360", type: "number", min: "180", step: "10", className: "w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500" }),
                        React.createElement("p", { className: "mt-1 text-xs text-gray-500" }, "Min: 180px"))),
                React.createElement("p", { className: "text-xs text-gray-500" }, "Dimensions will maintain 16:9 aspect ratio")),
            React.createElement("div", { className: "flex justify-end gap-2 mt-6" },
                React.createElement("button", { onClick: closeModal, className: "px-4 py-2 bg-gray-100 hover:bg-gray-200 text-gray-700 rounded-md" }, "Close"),
                React.createElement("button", { onClick: handleSubmit, disabled: !url, className: "px-4 py-2 bg-blue-500 hover:bg-blue-600 text-white rounded-md disabled:opacity-50 disabled:cursor-not-allowed" }, "Add")))));
}

function TableModal(_a) {
    var isOpen = _a.isOpen, closeModal = _a.closeModal, onSubmit = _a.onSubmit;
    var _b = React.useState("2"), rows = _b[0], setRows = _b[1];
    var _c = React.useState("3"), cols = _c[0], setCols = _c[1];
    var handleSubmit = function () {
        if (onSubmit) {
    ...
    return (React.createElement("div", { className: "fixed inset-0 bg-black/30 flex items-center justify-center z-50" },
        React.createElement("div", { className: "bg-white p-4 rounded-lg shadow-xl w-full max-w-md z-[9999] border border-gray-200" },
            React.createElement("div", { className: "flex justify-between items-center mb-4" },
                React.createElement("h3", { className: "text-lg font-semibold" }, "Insert Table"),
                React.createElement("button", { onClick: closeModal, className: "text-gray-500 hover:text-gray-700" }, "Close")),
            React.createElement("div", { className: "grid grid-cols-2 gap-4" },
                React.createElement("div", null,
                    React.createElement("label", { className: "block text-sm font-medium text-gray-700 mb-1" }, "Rows"),
                    React.createElement("input", { value: rows, onChange: function (e) { return setRows(e.target.value); }, placeholder: "Number of rows...", type: "number", min: "1", className: "w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500" })),
                React.createElement("div", null,
                    React.createElement("label", { className: "block text-sm font-medium text-gray-700 mb-1" }, "Columns"),
                    React.createElement("input", { value: cols, onChange: function (e) { return setCols(e.target.value); }, placeholder: "Number of columns...", type: "number", min: "1", className: "w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500" }))),
            React.createElement("div", { className: "flex justify-end gap-2 mt-6" },
                React.createElement("button", { onClick: closeModal, className: "px-4 py-2 bg-gray-100 hover:bg-gray-200 text-gray-700 rounded-md" }, "Close"),
                React.createElement("button", { onClick: handleSubmit, disabled: !rows || !cols || parseInt(rows) < 1 || parseInt(cols) < 1, className: "px-4 py-2 bg-blue-500 hover:bg-blue-600 text-white rounded-md disabled:opacity-50 disabled:cursor-not-allowed" }, "Add")))));
}
...
function LinkModal(_a) {
    ...
    var _d = React.useState(false), nofollow = _d[0], setNofollow = _d[1];
    React.useEffect(function () {
        if (isOpen) {
            if (selectedText) {
    ...
    return (React.createElement("div", { className: "fixed inset-0 bg-black/30 flex items-center justify-center z-50" },
        React.createElement("div", { className: "bg-white p-4 rounded-lg shadow-xl w-full max-w-md z-[9999] border border-gray-200" },
            ...
            React.createElement("div", { className: "space-y-4" },
                React.createElement("div", null,
                    React.createElement("label", { className: "block text-sm font-medium text-gray-700 mb-1" }, "Text"),
                    React.createElement("input", { value: text, onChange: function (e) { return setText(e.target.value); }, placeholder: "Link text (optional)...", className: "w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500" })),
                React.createElement("div", null,
                    React.createElement("label", { className: "block text-sm font-medium text-gray-700 mb-1" }, "URL"),
                    React.createElement("input", { value: url, onChange: function (e) { return setUrl(e.target.value); }, placeholder: "Insert URL...", className: "w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500" }))),
            React.createElement("div", { className: "flex justify-end gap-2 mt-6" },
                existingUrl && (React.createElement("button", { onClick: function () { onUnset === null || onUnset === void 0 ? void 0 : onUnset(); closeModal(); }, className: "px-4 py-2 bg-red-50 hover:bg-red-100 text-red-600 rounded-md mr-auto" }, "Remove link")),
                React.createElement("button", { onClick: closeModal, className: "px-4 py-2 bg-gray-100 hover:bg-gray-200 text-gray-700 rounded-md" }, "Close"),
                React.createElement("button", { onClick: handleSubmit, disabled: !url, className: "px-4 py-2 bg-blue-500 hover:bg-blue-600 text-white rounded-md disabled:opacity-50 disabled:cursor-not-allowed" }, "Add")))));
}

var BoldIcon = React__namespace.memo(function (_a) {
...
var AlignLeftIcon = React__namespace.memo(function (_a) {
    ...
    return (React__namespace.createElement("svg", __assign({ width: "24", height: "24", className: className, viewBox: "0 0 24 24", fill: "currentColor", xmlns: "http://www.w3.org/2000/svg" }, props),
        ...
        React__namespace.createElement("path", { fillRule: "evenodd", clipRule: "evenodd", d: "M2 12C2 11.4477 2.44772 11 3 11H15C15.5523 11 16 11.4477 16 12C16 12.5523 15.5523 13 15 13H3C2.44772 13 2 12.5523 2 12Z", fill: "currentColor" }),
        React__namespace.createElement("path", { fillRule: "evenodd", clipRule: "evenodd", d: "M2 18C2 17.4477 2.44772 17 3 17H17C17.5523 17 18 17.4477 18 18C18 18.5523 17.5523 19 17 19H3C2.44772 19 2 18.5523 2 18Z", fill: "currentColor" })));
});
AlignLeftIcon.displayName = "AlignLeftIcon";

var AlignCenterIcon = React__namespace.memo(function (_a) {
    var className = _a.className, props = __rest(_a, ["className"]);
    return (React__namespace.createElement("svg", __assign({ width: "24", height: "24", className: className, viewBox: "0 0 24 24", fill: "currentColor", xmlns: "http://www.w3.org/2000/svg" }, props),
        React__namespace.createElement("path", { fillRule: "evenodd", clipRule: "evenodd", d: "M2 6C2 5.44772 2.44772 5 3 5H21C21.5523 5 22 5.44772 22 6C22 6.55228 21.5523 7 21 7H3C2.44772 7 2 6.55228 2 6Z", fill: "currentColor" }),
        React__namespace.createElement("path", { fillRule: "evenodd", clipRule: "evenodd", d: "M6 12C6 11.4477 6.44772 11 7 11H17C17.5523 11 18 11.4477 18 12C18 12.5523 17.5523 13 17 13H7C6.44772 13 6 12.5523 6 12Z", fill: "currentColor" }),
        React__namespace.createElement("path", { fillRule: "evenodd", clipRule: "evenodd", d: "M4 18C4 17.4477 4.44772 17 5 17H19C19.5523 17 20 17.4477 20 18C20 18.5523 19.5523 19 19 19H5C4.44772 19 4 18.5523 4 18Z", fill: "currentColor" })));
});
AlignCenterIcon.displayName = "AlignCenterIcon";

var AlignRightIcon = React__namespace.memo(function (_a) {
    var className = _a.className, props = __rest(_a, ["className"]);
    return (React__namespace.createElement("svg", __assign({ width: "24", height: "24", className: className, viewBox: "0 0 24 24", fill: "currentColor", xmlns: "http://www.w3.org/2000/svg" }, props),
        React__namespace.createElement("path", { fillRule: "evenodd", clipRule: "evenodd", d: "M2 6C2 5.44772 2.44772 5 3 5H21C21.5523 5 22 5.44772 22 6C22 6.55228 21.5523 7 21 7H3C2.44772 7 2 6.55228 2 6Z", fill: "currentColor" }),
        React__namespace.createElement("path", { fillRule: "evenodd", clipRule: "evenodd", d: "M8 12C8 11.4477 8.44772 11 9 11H21C21.5523 11 22 11.4477 22 12C22 12.5523 21.5523 13 21 13H9C8.44772 13 8 12.5523 8 12Z", fill: "currentColor" }),
        React__namespace.createElement("path", { fillRule: "evenodd", clipRule: "evenodd", d: "M6 18C6 17.4477 6.44772 17 7 17H21C21.5523 17 22 17.4477 22 18C22 18.5523 21.5523 19 21 19H7C6.44772 19 6 18.5523 6 18Z", fill: "currentColor" })));
});
...
var ListIcon = React__namespace.memo(function (_a) {
    var className = _a.className, props = __rest(_a, ["className"]);
    return (React__namespace.createElement("svg", __assign({ width: "24", height: "24", className: className, viewBox: "0 0 24 24", fill: "currentColor", xmlns: "http://www.w3.org/2000/svg" }, props),
        React__namespace.createElement("path", { fillRule: "evenodd", clipRule: "evenodd", d: "M7 6C7 5.44772 7.44772 5 8 5H21C21.5523 5 22 5.44772 22 6C22 6.55228 21.5523 7 21 7H8C7.44772 7 7 6.55228 7 6Z", fill: "currentColor" }),
        React__namespace.createElement("path", { fillRule: "evenodd", clipRule: "evenodd", d: "M7 12C7 11.4477 7.44772 11 8 11H21C21.5523 11 22 11.4477 22 12C22 12.5523 21.5523 13 21 13H8C7.44772 13 7 12.5523 7 12Z", fill: "currentColor" }),
        React__namespace.createElement("path", { fillRule: "evenodd", clipRule: "evenodd", d: "M7 18C7 17.4477 7.44772 17 8 17H21C21.5523 17 22 17.4477 22 18C22 18.5523 21.5523 19 21 19H8C7.44772 19 7 18.5523 7 18Z", fill: "currentColor" }),
        React__namespace.createElement("path", { fillRule: "evenodd", clipRule: "evenodd", d: "M2 6C2 5.44772 2.44772 5 3 5H3.01C3.56228 5 4.01 5.44772 4.01 6C4.01 6.55228 3.56228 7 3.01 7H3C2.44772 7 2 6.55228 2 6Z", fill: "currentColor" }),
        React__namespace.createElement("path", { fillRule: "evenodd", clipRule: "evenodd", d: "M2 12C2 11.4477 2.44772 11 3 11H3.01C3.56228 11 4.01 11.4477 4.01 12C4.01 12.5523 3.56228 13 3.01 13H3C2.44772 13 2 12.5523 2 12Z", fill: "currentColor" }),
        React__namespace.createElement("path", { fillRule: "evenodd", clipRule: "evenodd", d: "M2 18C2 17.4477 2.44772 17 3 17H3.01C3.56228 17 4.01 17.4477 4.01 18C4.01 18.5523 3.56228 19 3.01 19H3C2.44772 19 2 18.5523 2 18Z", fill: "currentColor" })));
});
ListIcon.displayName = "ListIcon";

var ListOrderedIcon = React__namespace.memo(function (_a) {
    var className = _a.className, props = __rest(_a, ["className"]);
    return (React__namespace.createElement("svg", __assign({ width: "24", height: "24", className: className, viewBox: "0 0 24 24", fill: "currentColor", xmlns: "http://www.w3.org/2000/svg" }, props),
        React__namespace.createElement("path", { fillRule: "evenodd", clipRule: "evenodd", d: "M9 6C9 5.44772 9.44772 5 10 5H21C21.5523 5 22 5.44772 22 6C22 6.55228 21.5523 7 21 7H10C9.44772 7 9 6.55228 9 6Z", fill: "currentColor" }),
        React__namespace.createElement("path", { fillRule: "evenodd", clipRule: "evenodd", d: "M9 12C9 11.4477 9.44772 11 10 11H21C21.5523 11 22 11.4477 22 12C22 12.5523 21.5523 13 21 13H10C9.44772 13 9 12.5523 9 12Z", fill: "currentColor" }),
        React__namespace.createElement("path", { fillRule: "evenodd", clipRule: "evenodd", d: "M9 18C9 17.4477 9.44772 17 10 17H21C21.5523 17 22 17.4477 22 18C22 18.5523 21.5523 19 21 19H10C9.44772 19 9 18.5523 9 18Z", fill: "currentColor" }),
        React__namespace.createElement("path", { fillRule: "evenodd", clipRule: "evenodd", d: "M3 6C3 5.44772 3.44772 5 4 5H5C5.55228 5 6 5.44772 6 6V10C6 10.5523 5.55228 11 5 11C4.44772 11 4 10.5523 4 10V7C3.44772 7 3 6.55228 3 6Z", fill: "currentColor" }),
        React__namespace.createElement("path", { fillRule: "evenodd", clipRule: "evenodd", d: "M3 10C3 9.44772 3.44772 9 4 9H6C6.55228 9 7 9.44772 7 10C7 10.5523 6.55228 11 6 11H4C3.44772 11 3 10.5523 3 10Z", fill: "currentColor" }),
        React__namespace.createElement("path", { fillRule: "evenodd", clipRule: "evenodd", d: "M5.82219 13.0431C6.54543 13.4047 6.99997 14.1319 6.99997 15C6.99997 15.5763 6.71806 16.0426 6.48747 16.35C6.31395 16.5814 6.1052 16.8044 5.91309 17H5.99997C6.55226 17 6.99997 17.4477 6.99997 18C6.99997 18.5523 6.55226 19 5.99997 19H3.99997C3.44769 19 2.99997 18.5523 2.99997 18C2.99997 17.4237 3.28189 16.9575 3.51247 16.65C3.74323 16.3424 4.03626 16.0494 4.26965 15.8161C4.27745 15.8083 4.2852 15.8006 4.29287 15.7929C4.55594 15.5298 4.75095 15.3321 4.88748 15.15C4.96287 15.0495 4.99021 14.9922 4.99911 14.9714C4.99535 14.9112 4.9803 14.882 4.9739 14.8715C4.96613 14.8588 4.95382 14.845 4.92776 14.8319C4.87723 14.8067 4.71156 14.7623 4.44719 14.8944C3.95321 15.1414 3.35254 14.9412 3.10555 14.4472C2.85856 13.9533 3.05878 13.3526 3.55276 13.1056C4.28839 12.7378 5.12272 12.6934 5.82219 13.0431Z", fill: "currentColor" })));
});
...
var BlockquoteIcon = React__namespace.memo(function (_a) {
    var className = _a.className, props = __rest(_a, ["className"]);
    return (React__namespace.createElement("svg", __assign({ width: "24", height: "24", className: className, viewBox: "0 0 24 24", fill: "currentColor", xmlns: "http://www.w3.org/2000/svg" }, props),
        React__namespace.createElement("path", { fillRule: "evenodd", clipRule: "evenodd", d: "M8 6C8 5.44772 8.44772 5 9 5H16C16.5523 5 17 5.44772 17 6C17 6.55228 16.5523 7 16 7H9C8.44772 7 8 6.55228 8 6Z", fill: "currentColor" }),
        React__namespace.createElement("path", { fillRule: "evenodd", clipRule: "evenodd", d: "M4 3C4.55228 3 5 3.44772 5 4L5 20C5 20.5523 4.55229 21 4 21C3.44772 21 3 20.5523 3 20L3 4C3 3.44772 3.44772 3 4 3Z", fill: "currentColor" }),
        React__namespace.createElement("path", { fillRule: "evenodd", clipRule: "evenodd", d: "M8 12C8 11.4477 8.44772 11 9 11H20C20.5523 11 21 11.4477 21 12C21 12.5523 20.5523 13 20 13H9C8.44772 13 8 12.5523 8 12Z", fill: "currentColor" }),
        React__namespace.createElement("path", { fillRule: "evenodd", clipRule: "evenodd", d: "M8 18C8 17.4477 8.44772 17 9 17H16C16.5523 17 17 17.4477 17 18C17 18.5523 16.5523 19 16 19H9C8.44772 19 8 18.5523 8 18Z", fill: "currentColor" })));
});
...
function FormatMenu(_a) {
    ...
    var _c = React.useState(false), textStyleOpen = _c[0], setTextStyleOpen = _c[1];
    var _d = React.useState(false), formatsOpen = _d[0], setFormatsOpen = _d[1];
    var _e = React.useState(false), fontSizeOpen = _e[0], setFontSizeOpen = _e[1];
        ...
        open && (React.createElement("div", { className: "absolute z-50 mt-1 bg-white border rounded shadow min-w-[220px] py-1" },
            React.createElement("div", { className: "relative", onMouseEnter: function () { return setTextStyleOpen(true); }, onMouseLeave: function () { return setTextStyleOpen(false); } },
                React.createElement("button", { className: "w-full flex items-center justify-between px-3 py-2 text-sm hover:bg-gray-100" },
                    React.createElement("span", null, "Text style"),
                    React.createElement(ChevronRightIcon$1, { className: "w-4 h-4 inline" })),
                textStyleOpen && (React.createElement("div", { className: "absolute left-full top-0 ml-1 bg-white border rounded shadow p-2 z-50 min-w-[240px] " },
                    React.createElement("button", { className: "block w-full text-left px-2 py-1.5 hover:bg-gray-100 text-sm flex items-center gap-2 rounded-md", onClick: function () { return editor.chain().focus().toggleBold().run(); } },
                        React.createElement(BoldIcon, { className: "w-4 h-4 inline text-gray-800" }),
                        " Bold"),
                    React.createElement("button", { className: "block w-full text-left px-2 py-1.5 hover:bg-gray-100 text-sm flex items-center gap-2 rounded-md", onClick: function () { return editor.chain().focus().toggleItalic().run(); } },
                        React.createElement(ItalicIcon, { className: "w-4 h-4 inline text-gray-800" }),
                        " Italic"),
                    React.createElement("button", { className: "block w-full text-left px-2 py-1.5 hover:bg-gray-100 text-sm flex items-center gap-2 rounded-md", onClick: function () { return editor.chain().focus().toggleUnderline().run(); } },
                        React.createElement(UnderlineIcon, { className: "w-4 h-4 inline text-gray-800" }),
                        " Underline"),
                    React.createElement("button", { className: "block w-full text-left px-2 py-1.5 hover:bg-gray-100 text-sm flex items-center gap-2 rounded-md", onClick: function () { return editor.chain().focus().toggleStrike().run(); } },
                        React.createElement(StrikeIcon, { className: "w-4 h-4 inline text-gray-800" }),
                        " Strikethrough"),
                    React.createElement("button", { className: "block w-full text-left px-2 py-1.5 hover:bg-gray-100 text-sm flex items-center gap-2 rounded-md", onClick: function () { return editor.chain().focus().toggleSuperscript().run(); } },
                        React.createElement(SuperscriptIcon, { className: "w-4 h-4 inline text-gray-800" }),
                        " Superscript"),
                    React.createElement("button", { className: "block w-full text-left px-2 py-1.5 hover:bg-gray-100 text-sm flex items-center gap-2 rounded-md", onClick: function () { return editor.chain().focus().toggleSubscript().run(); } },
                        React.createElement(SubscriptIcon, { className: "w-4 h-4 inline text-gray-800" }),
                        " Subscript"),
                    React.createElement("button", { className: "block w-full text-left px-2 py-1.5 hover:bg-gray-100 text-sm flex items-center gap-2 rounded-md", onClick: function () { return editor.chain().focus().toggleCode().run(); } },
                        React.createElement(Code2Icon, { className: "w-4 h-4 inline text-gray-800" }),
                        " Code")))),
            React.createElement("div", { className: "relative", onMouseEnter: function () { return setFormatsOpen(true); }, onMouseLeave: function () { return setFormatsOpen(false); } },
                React.createElement("button", { className: "w-full flex items-center justify-between px-3 py-2 text-sm hover:bg-gray-100" },
                    React.createElement("span", null, "Formats"),
                    React.createElement(ChevronRightIcon$1, { className: "w-4 h-4 inline" })),
                formatsOpen && (React.createElement("div", { className: "absolute left-full top-0 ml-1 bg-white border rounded shadow p-2 z-50 min-w-[200px]" },
                    [1, 2, 3, 4, 5, 6].map(function (level) { return (React.createElement("button", { key: level, className: "block w-full text-left px-2 py-1.5 hover:bg-gray-100 text-sm rounded-md", onClick: function () { return editor.chain().focus().toggleHeading({ level: level }).run(); } },
                        "Heading ",
                        level)); }),
                    React.createElement("button", { className: "block w-full text-left px-2 py-1.5 hover:bg-gray-100 text-sm rounded-md", onClick: function () { return editor.chain().focus().setParagraph().run(); } }, "Paragraph")))),
            React.createElement("div", { className: "relative", onMouseEnter: function () { return setFontSizeOpen(true); }, onMouseLeave: function () { return setFontSizeOpen(false); } },
                React.createElement("button", { className: "w-full flex items-center justify-between px-3 py-2 text-sm hover:bg-gray-100" },
                    React.createElement("span", null, "Font size"),
                    React.createElement(ChevronRightIcon$1, { className: "w-4 h-4 inline" })),
                fontSizeOpen && (React.createElement("div", { className: "absolute left-full top-0 ml-1 bg-white border rounded shadow p-2 z-50 min-w-[160px] max-h-64 overflow-auto" }, fontSizes.map(function (s) { return (React.createElement("button", { key: s, className: "block w-full text-left px-2 py-1.5 hover:bg-gray-100 text-sm rounded-md", onClick: function () { return editor.chain().focus().setFontSize("".concat(s, "px")).run(); } },
                    s,
                    "px")); })))),
            React.createElement("div", { className: "relative", onMouseEnter: function () { return setAlignOpen(true); }, onMouseLeave: function () { return setAlignOpen(false); } },
                React.createElement("button", { className: "w-full flex items-center justify-between px-3 py-2 text-sm hover:bg-gray-100" },
                    React.createElement("span", null, "Align"),
                    React.createElement(ChevronRightIcon$1, { className: "w-4 h-4 inline" })),
                alignOpen && (React.createElement("div", { className: "absolute left-full top-0 ml-1 bg-white border rounded shadow p-2 z-50 min-w-[180px]" },
                    React.createElement("button", { className: "block w-full text-left px-2 py-1.5 hover:bg-gray-100 text-sm flex items-center gap-2 rounded-md", onClick: function () {
                        ...
                        React.createElement(AlignLeftIcon, { className: "w-4 h-4 inline" }),
                        " Left"),
                    React.createElement("button", { className: "block w-full text-left px-2 py-1.5 hover:bg-gray-100 text-sm flex items-center gap-2 rounded-md", onClick: function () {
                            if (editor.isActive('image'))
                        ...
                        React.createElement(AlignCenterIcon, { className: "w-4 h-4 inline" }),
                        " Center"),
                    React.createElement("button", { className: "block w-full text-left px-2 py-1.5 hover:bg-gray-100 text-sm flex items-center gap-2 rounded-md", onClick: function () {
                            if (editor.isActive('image'))
            ...
            React.createElement("div", { className: "relative", onMouseEnter: function () { return setListsOpen(true); }, onMouseLeave: function () { return setListsOpen(false); } },
                React.createElement("button", { className: "w-full flex items-center justify-between px-3 py-2 text-sm hover:bg-gray-100" },
                    ...
                    React.createElement(ChevronRightIcon$1, { className: "w-4 h-4 inline" })),
                listsOpen && (React.createElement("div", { className: "absolute left-full top-0 ml-1 bg-white border rounded shadow p-2 z-50 min-w-[180px]" },
                    React.createElement("button", { className: "block w-full text-left px-2 py-1.5 hover:bg-gray-100 text-sm rounded-md flex items-center gap-2", onClick: function () { return editor.chain().focus().toggleBulletList().run(); } },
                        React.createElement(ListIcon, { className: "w-4 h-4 inline" }),
                        " Bulleted"),
                    React.createElement("button", { className: "block w-full text-left px-2 py-1.5 hover:bg-gray-100 text-sm rounded-md flex items-center gap-2", onClick: function () { return editor.chain().focus().toggleOrderedList().run(); } },
                        React.createElement(ListOrderedIcon, { className: "w-4 h-4 inline" }),
                        " Numbered")))),
            React.createElement("div", { className: "relative", onMouseEnter: function () { return setColorsOpen(true); }, onMouseLeave: function () { return setColorsOpen(false); } },
                React.createElement("button", { className: "w-full flex items-center justify-between px-3 py-2 text-sm hover:bg-gray-100" },
                    React.createElement("span", null, "Colors"),
                    React.createElement(ChevronRightIcon$1, { className: "w-4 h-4 inline" })),
                colorsOpen && (React.createElement("div", { className: "absolute left-full top-0 ml-1 bg-white border rounded shadow p-2 z-50 min-w-[220px]" },
                    React.createElement("div", { className: "px-2 py-1 text-xs text-gray-500 flex items-center gap-2" }, "Text"),
                    React.createElement("input", { "aria-label": "text color", type: "color", className: "ml-2 mb-2 h-8 w-8 cursor-pointer", onChange: function (e) { return editor.chain().focus().setColor(e.target.value).run(); } }),
                    React.createElement("div", { className: "px-2 py-1 text-xs text-gray-500" }, "Background"),
                    React.createElement("input", { "aria-label": "background color", type: "color", className: "ml-2 h-8 w-8 cursor-pointer", onChange: function (e) { return editor.chain().focus().setHighlight({ color: e.target.value }).run(); } })))),
            React.createElement("button", { className: "w-full flex items-center justify-between px-3 py-2 text-sm hover:bg-gray-100", onClick: function () { return editor.chain().focus().toggleBlockquote().run(); } },
                React.createElement("span", null, "Blockquote"),
                React.createElement(BlockquoteIcon, { className: "w-4 h-4 inline" }))))));
}
...
function FileMenuBar(_a) {
    ...
    var _b = React.useState(false), fileOpen = _b[0], setFileOpen = _b[1];
    var _c = React.useState(false), editOpen = _c[0], setEditOpen = _c[1];
    var _d = React.useState(false), insertOpen = _d[0], setInsertOpen = _d[1];
    var _e = React.useState(false), isYoutubeModalOpen = _e[0], setIsYoutubeModalOpen = _e[1];
    var _f = React.useState(false), setIsImageModalOpen = _f[1];
    var _g = React.useState(false), isTableModalOpen = _g[0], setIsTableModalOpen = _g[1];
    ...
    return (React.createElement("div", { className: "flex items-center gap-3 px-2 sm:px-4 py-1 ml-2" },
        React.createElement("div", { className: "relative", ref: fileRef },
            React.createElement("button", { className: "text-gray-600 hover:text-gray-900 text-xs sm:text-sm", onClick: function () { return setFileOpen(!fileOpen); } }, "File"),
            fileOpen && (React.createElement("div", { className: "absolute z-50 mt-1 bg-white border rounded shadow min-w-[180px]" },
                React.createElement("button", { className: "w-full text-left px-3 py-2 hover:bg-gray-100 text-sm", onClick: function () { editor.commands.clearContent(true); setFileOpen(false); } }, "New")))),
        React.createElement("div", { className: "relative", ref: editRef },
            React.createElement("button", { className: "text-gray-600 hover:text-gray-900 text-xs sm:text-sm", onClick: function () { return setEditOpen(!editOpen); } }, "Edit"),
            editOpen && (React.createElement("div", { className: "absolute z-50 mt-1 bg-white border rounded shadow min-w-[220px] p-1" },
                React.createElement("button", { className: "w-full text-left px-3 py-1 hover:bg-gray-100 text-sm", onClick: function () { return editor.chain().focus().undo().run(); } }, "Undo"),
                React.createElement("button", { className: "w-full text-left px-3 py-1 hover:bg-gray-100 text-sm", onClick: function () { return editor.chain().focus().redo().run(); } }, "Redo"),
                React.createElement("div", { className: "h-px bg-gray-200 my-1" }),
                React.createElement("button", { className: "w-full text-left px-3 py-1 hover:bg-gray-100 text-sm", onClick: function () { return document.execCommand('cut'); } }, "Cut"),
                React.createElement("button", { className: "w-full text-left px-3 py-1 hover:bg-gray-100 text-sm", onClick: function () { return document.execCommand('copy'); } }, "Copy"),
                React.createElement("button", { className: "w-full text-left px-3 py-1 hover:bg-gray-100 text-sm", onClick: function () { return document.execCommand('paste'); } }, "Paste"),
                React.createElement("div", { className: "h-px bg-gray-200 my-1" }),
                React.createElement("button", { className: "w-full text-left px-3 py-1 hover:bg-gray-100 text-sm", onClick: function () { onOpenFindReplace(); setEditOpen(false); } }, "Find & Replace")))),
        React.createElement("div", { className: "relative", ref: insertRef },
            React.createElement("button", { className: "text-gray-600 hover:text-gray-900 text-xs sm:text-sm", onClick: function () { return setInsertOpen(!insertOpen); } }, "Insert"),
            insertOpen && (React.createElement("div", { className: "absolute z-50 mt-1 bg-white border rounded shadow min-w-[220px] p-1" },
                React.createElement("button", { className: "w-full text-left px-3 py-1 hover:bg-gray-100 text-sm", onClick: function () { return setIsImageModalOpen(true); } }, "Image"),
                React.createElement("button", { className: "w-full text-left px-3 py-1 hover:bg-gray-100 text-sm", onClick: function () { return setIsLinkModalOpen(true); } }, "Link"),
                React.createElement("button", { className: "w-full text-left px-3 py-1 hover:bg-gray-100 text-sm", onClick: function () { return setIsYoutubeModalOpen(true); } }, "Video"),
                React.createElement("button", { className: "w-full text-left px-3 py-1 hover:bg-gray-100 text-sm", onClick: function () { return setIsTableModalOpen(true); } }, "Table"),
                React.createElement("button", { className: "w-full text-left px-3 py-1 hover:bg-gray-100 text-sm", onClick: function () { return editor.chain().focus().setHorizontalRule().run(); } }, "Horizontal Line")))),
        React.createElement(FormatMenu, { editor: editor }),
        ...
        React.createElement(LinkModal, { isOpen: isLinkModalOpen, closeModal: function () { return setIsLinkModalOpen(false); }, onSubmit: function (_a) {
...
// src/subscript.ts
var Subscript = core.Mark.create({
  name: "subscript",
  addOptions() {
    return {
      HTMLAttributes: {}
...
// src/superscript.ts
var Superscript = core.Mark.create({
  name: "superscript",
  addOptions() {
    return {
      HTMLAttributes: {}
...
var TextStyle = core.Mark.create({
  name: "textStyle",
  priority: 101,
  addOptions() {
    return {
...
var BackgroundColor = core.Extension.create({
...
var FontFamily = core.Extension.create({
  name: "fontFamily",
  addOptions() {
    return {
      types: ["textStyle"]
...
var FontSize$1 = core.Extension.create({
  name: "fontSize",
  addOptions() {
    return {
      types: ["textStyle"]
...
var LineHeight = core.Extension.create({
  name: "lineHeight",
  addOptions() {
    return {
      types: ["textStyle"]
...
var TextStyleKit = core.Extension.create({
  name: "textStyleKit",
  addExtensions() {
    const extensions = [];
...
function YouTubeNodeView(_a) {
    ...
    var startPosRef = React.useRef({ x: 0, y: 0, width: 0, height: 0 });
    ...
    return (React.createElement(react$1.NodeViewWrapper, { className: "youtube-wrapper" },
        React.createElement("div", { ref: nodeRef, className: "youtube-video ".concat(selected ? 'ProseMirror-selectednode' : ''), "data-align": node.attrs.align || 'left', style: {
            ...
            React.createElement("iframe", { src: node.attrs.src, width: "100%", height: "100%", style: { position: 'absolute', top: 0, left: 0, borderRadius: '8px' }, frameBorder: "0", allowFullScreen: true, allow: "accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" }),
...
var YoutubeAlign = index_default$1.extend({
    ...
    renderHTML: function (_a) {
        ...
        return [
            'div',
            core.mergeAttributes({ class: 'youtube-video', 'data-align': align || 'left' }, rest),
            [
                'iframe',
                core.mergeAttributes({
                    width: width || '640',
...
var CharacterCount = core.Extension.create({
  name: "characterCount",
  addOptions() {
    return {
      limit: null,
...
core.Extension.create({
  ...
  extendNodeSchema(extension) {
    ...
    return {
      allowGapCursor: (_a = core.callOrReturn(core.getExtensionField(extension, "allowGapCursor", context))) != null ? _a : null
    };
  }
});
core.Extension.create({
  ...
  addProseMirrorPlugins() {
    ...
    return [
      new state.Plugin({
        ...
        props: {
          decorations(state) {
            if (state.selection.empty || editor.isFocused || !editor.isEditable || core.isNodeSelection(state.selection) || editor.view.dragging) {
              return null;
            }
...
function FindReplace(_a) {
    ...
    var _b = React.useState(''), findText = _b[0], setFindText = _b[1];
    var _c = React.useState(''), replaceText = _c[0], setReplaceText = _c[1];
    var _d = React.useState(-1), currentMatch = _d[0], setCurrentMatch = _d[1];
    var _e = React.useState([]), matches = _e[0], setMatches = _e[1];
    ...
    var findTextInEditor = React.useCallback(function (searchText) {
        var _a, _b, _c, _d, _e;
    ...
    var updateHighlights = React.useCallback(function (newCurrentMatch) {
        var _a, _b, _c, _d, _e;
    ...
    var findNext = React.useCallback(function () {
    ...
    var findPrevious = React.useCallback(function () {
        if (matches.length === 0 || currentMatch === -1)
            return;
    ...
    var replaceCurrent = React.useCallback(function () {
    ...
    var replaceAll = React.useCallback(function () {
    ...
    return (React.createElement("div", { className: "fixed inset-0 bg-black/30 flex items-center justify-center z-50" },
        React.createElement("div", { className: "bg-white p-4 rounded-lg shadow-xl w-full max-w-md z-[9999] border border-gray-200" },
            React.createElement("div", { className: "flex justify-between items-center mb-4" },
                React.createElement("h3", { className: "text-lg font-medium" }, "Find & Replace"),
            ...
            React.createElement("div", { className: "space-y-4" },
                React.createElement("div", null,
                    React.createElement("label", { className: "block text-sm font-medium text-gray-700 mb-1" }, "Find"),
                    React.createElement("input", { ref: findInputRef, type: "text", value: findText, onChange: handleFindChange, onKeyDown: handleKeyDown, className: "w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500", placeholder: "Find..." })),
                React.createElement("div", null,
                    React.createElement("label", { className: "block text-sm font-medium text-gray-700 mb-1" }, "Replace With"),
                    React.createElement("input", { type: "text", value: replaceText, onChange: function (e) { return setReplaceText(e.target.value); }, onKeyDown: handleKeyDown, className: "w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500", placeholder: "Replace with..." })),
                React.createElement("div", { className: "flex flex-col gap-2" },
                    React.createElement("div", { className: "flex items-center justify-between text-sm" },
                        React.createElement("span", { className: "text-gray-600 font-medium" }, matches.length > 0
                            ? "".concat(currentMatch + 1, " of ").concat(matches.length, " matches")
                            : findText ? 'No matches found' : 'Type to start searching'),
                        React.createElement("div", { className: "text-xs text-gray-500" },
                            React.createElement("span", { className: "mr-4" }, "Enter: Next"),
                            React.createElement("span", { className: "mr-4" }, "Shift+Enter: Previous"),
                            React.createElement("span", null, "Tab: Switch fields"))),
                    React.createElement("div", { className: "flex justify-between items-center" },
                        React.createElement("div", { className: "flex space-x-2" },
                            React.createElement("button", { onClick: findPrevious, disabled: matches.length === 0, title: "Previous match (Shift+Enter)", className: "px-3 py-1.5 text-sm rounded-md transition-colors ".concat(matches.length > 0
                                    ? 'bg-blue-50 text-blue-700 hover:bg-blue-100 border border-blue-200'
                                    : 'bg-gray-50 text-gray-400 border border-gray-200 cursor-not-allowed') }, "Previous"),
                            React.createElement("button", { onClick: findNext, disabled: matches.length === 0, title: "Next match (Enter)", className: "px-3 py-1.5 text-sm rounded-md transition-colors ".concat(matches.length > 0
                                    ? 'bg-blue-50 text-blue-700 hover:bg-blue-100 border border-blue-200'
                                    : 'bg-gray-50 text-gray-400 border border-gray-200 cursor-not-allowed') }, "Next")),
                        React.createElement("div", { className: "flex space-x-2" },
                            React.createElement("button", { onClick: replaceCurrent, disabled: matches.length === 0, title: "Replace current match", className: "px-3 py-1.5 text-sm rounded-md transition-colors ".concat(matches.length > 0
                                    ? 'bg-blue-50 text-blue-700 hover:bg-blue-100 border border-blue-200'
                                    : 'bg-gray-50 text-gray-400 border border-gray-200 cursor-not-allowed') }, "Replace"),
                            React.createElement("button", { onClick: replaceAll, disabled: matches.length === 0, title: "Replace all ".concat(matches.length, " matches"), className: "px-3 py-1.5 text-sm rounded-md transition-colors ".concat(matches.length > 0
...
function MagicPencilIcon (_a) {
    ...
    return (React.createElement("svg", { xmlns: "http://www.w3.org/2000/svg", width: "24", height: "24", viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", strokeWidth: "2", strokeLinecap: "round", strokeLinejoin: "round", className: className },
        ...
        React.createElement("path", { d: "M4 20h1" }),
        React.createElement("path", { d: "m2 22 1-1" }),
        React.createElement("path", { d: "M20 14h2" }),
        React.createElement("path", { d: "M21 13v2" }),
        React.createElement("path", { d: "M17 17l2 2" })));
}
...
var AIModal = function (_a) {
    ...
    var _e = React.useState('professional'), style = _e[0], setStyle = _e[1];
    React.useEffect(function () {
        if (isOpen) {
            setPrompt("");
            setLength('medium');
    ...
    if (!isOpen)
        return null;
    return (React.createElement("div", { className: "fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-20" },
...
var MenuBar = function (_a) {
    ...
    var _c = React.useState(false), isYoutubeModalOpen = _c[0], setIsYoutubeModalOpen = _c[1];
    var _d = React.useState(false), isAIModalOpen = _d[0], setIsAIModalOpen = _d[1];
    ...
    var _e = React.useState(false), isImageModalOpen = _e[0], setIsImageModalOpen = _e[1];
    ...
    var _f = React.useState(false), isTableModalOpen = _f[0], setIsTableModalOpen = _f[1];
    var _g = React.useState(false), isLinkModalOpen = _g[0], setIsLinkModalOpen = _g[1];
    var handleTableSubmit = function (_a) {
        var rows = _a.rows, cols = _a.cols;
    ...
    return (React.createElement("div", { className: "border-b border-gray-200 bg-white z-[9999] rounded-lg" },
        React.createElement("div", { className: "flex flex-wrap items-center gap-1 sm:gap-2.5 px-2 sm:px-4 py-2 overflow-x-auto overflow-y-visible" },
            ...
            React.createElement("div", { className: "flex items-center gap-1 border-r pr-1 sm:pr-2" },
                React.createElement("select", { value: editor.isActive('paragraph') ? 'paragraph' : editor.isActive('heading') ? "h".concat(editor.getAttributes('heading').level) : 'paragraph', onChange: function (e) { return handleHeadingChange(e.target.value); }, className: "px-2 py-1.5 border border-gray-200 rounded-md text-xs sm:text-sm min-w-[90px] sm:min-w-[130px] bg-white hover:border-gray-300 focus:outline-none focus:ring-2 focus:ring-blue-500" },
                    ...
                    React.createElement("option", { value: "h5" }, "Heading 5"),
                    React.createElement("option", { value: "h6" }, "Heading 6")),
                React.createElement("select", { value: getCurrentFontSize(), onChange: function (e) { return handleFontSizeChange(e.target.value); }, className: "px-2 py-1.5 border border-gray-200 rounded-md text-xs sm:text-sm min-w-[60px] sm:min-w-[80px] bg-white hover:border-gray-300 focus:outline-none focus:ring-2 focus:ring-blue-500", disabled: editor.isActive('heading') }, FONT_SIZES.map(function (size) { return (React.createElement("option", { key: size, value: size },
                    size,
                    "px")); }))),
            React.createElement("div", { className: "flex items-center gap-1 border-r pr-1 sm:pr-2" },
            ...
            React.createElement("div", { className: "flex items-center gap-1 border-l pr-1 sm:pr-2" },
                ...
                React.createElement("button", { onClick: function () { return setIsAIModalOpen(true); }, className: "p-1.5 rounded-md transition-colors hover:bg-purple-100 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-purple-500", title: "Generate content with AI" },
                    React.createElement(MagicPencilIcon, { className: "w-5 h-5 text-purple-600" })))),
        ...
        React.createElement(AIModal, { isOpen: isAIModalOpen, closeModal: function () { return setIsAIModalOpen(false); }, editor: editor })));
};

var TranslateIcon = React__namespace.memo(function (_a) {
    var className = _a.className, props = __rest(_a, ["className"]);
    return (React__namespace.createElement("svg", __assign({ width: "24", height: "24", className: className, viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", strokeWidth: "2", strokeLinecap: "round", strokeLinejoin: "round", xmlns: "http://www.w3.org/2000/svg" }, props),
...
var AIBubbleMenu = function (_a) {
    ...
    return (React.createElement(menus.BubbleMenu, { editor: editor, options: { placement: 'top' }, shouldShow: shouldShow, className: "flex overflow-hidden rounded-lg border border-gray-200 bg-white shadow-xl ring-1 ring-black ring-opacity-5 z-[9999]" },
        React.createElement("div", { className: "flex p-1 gap-1" },
            ...
            React.createElement("div", { className: "w-px bg-gray-200 my-1" }),
            React.createElement(MenuButton, { onClick: function () { return handleAction('translate'); }, isActive: isLoading === 'translate', label: "Translate", icon: React.createElement(TranslateIcon, { className: "w-3.5 h-3.5" }) }))));
};
...
var RichTextEditor = function (_a) {
    ...
    var unsetLink = React.useCallback(function () {
        if (!editor)
            return;
        editor.chain().focus().unsetLink().run();
    }, [editor]);
    ...
    return (React.createElement("div", { className: "w-full bg-white rounded-lg shadow-lg" },
        ...
        editor && (React.createElement(EditorContainer, null,
            React.createElement("div", { className: "min-h-[300px] border-t border-gray-200" },
                React.createElement(AIBubbleMenu, { editor: editor }),

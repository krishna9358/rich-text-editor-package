...
var AIBubbleMenu = function (_a) {
    ...
    return (React.createElement(menus.BubbleMenu, { editor: editor, options: { placement: 'top' }, shouldShow: shouldShow, className: "flex overflow-hidden rounded-lg border border-gray-200 bg-white shadow-xl ring-1 ring-black ring-opacity-5" },
